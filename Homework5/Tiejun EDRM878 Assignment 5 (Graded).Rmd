...
```{r}
predict(shuttle.model, newdata=data.frame(Temp=31), type="response")
```
...
**As you know, I'm not a fan of automated methods. It also looks like you made**
**this too difficult. Take a look at my work for a straightforward way to**
**build the model and interpret in specific terms.**
